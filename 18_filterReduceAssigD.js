...
console.log(` `);
console.log("2.Find all employee from 'IT' and 'HR' Depatment");
arrayEmps.filter((element)=>{
...
console.log(` `);
console.log("4. Find all employee whose names strat with letter 'A' or 'V' or 'M'");
arrayEmps.filter((element)=>{
...
console.log(` `);
console.log("5.Find Average salary of the employee for all the department using filter and reduce method");
const newArray = []
arrayEmps.filter((element)=>{
...
console.log(` `);
console.log("5.Find Average salary for 'IT' department using filter and reduce method");
const newArray1 = []
arrayEmps.filter((element)=>{
